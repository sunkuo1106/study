...
// 阿里云主账号AccessKey拥有所有API的访问权限，风险很高。强烈建议您创建并使用RAM账号进行API访问或日常运维，请登录 https://ram.console.aliyun.com 创建RAM账号。
        String accessKeyId = "LTAI4G66hLKqbUjqq46sPPKw";
        String accessKeySecret = "ZmmDiHDGlmLezfvZx4dmqzOSkCEO3e";
// 创建OSSClient实例。
       String objectName="test/";
       String backetName="liuouou";
       String prefix="https://liuouou.oss-cn-beijing.aliyuncs.com/";
       //获取就文件名
